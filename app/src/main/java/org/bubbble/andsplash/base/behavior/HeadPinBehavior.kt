...
class HeadPinBehavior<V: View>(context: Context, attrs: AttributeSet) :
    ...
    override fun layoutDependsOn(
        ...
        if (pinLocation == 0F) {
            // 获取默认距离
            childY = child.y
            pinLocation = 0F - child.findViewById<LinearLayout>(R.id.appbar).height
    ...
    override fun onNestedPreScroll(
        ...
        if (dy > 0) {
            ...
            if (pinLocation >= child.y - dy) {
                ...
                child.y = pinLocation
                child.findViewById<LinearLayout>(R.id.appbar).alpha = 0F
                return
            }
            ...
            if (childY <= child.y - dy) {
                ...
                child.y = childY
                child.findViewById<LinearLayout>(R.id.appbar).alpha = 1F
                return
            }
        ...
        child.findViewById<LinearLayout>(R.id.appbar).alpha = alpha
